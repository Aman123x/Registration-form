document.addEventListener("DOMContentLoaded", function () {
    let editingDataId = null; // Variable to store the _id of the data being edited
    ...
    function displayStoredData(storedData) {
        ...
        editButton.addEventListener("click", function () {
            // Set the editingDataId to the _id of the data being edited
    ...
    function deleteDataFromDatabase(id) {
        ...
        axios.delete(`https://crudcrud.com/api/cfc899b2493b4d27943656056e66505a/appointmentData/${id}`)
            .then((response) => {
    ...
    form.addEventListener("submit", function (event) {
        ...
        if (editingDataId) {
            // If editingDataId is not null, update the existing data
            axios.put(`https://crudcrud.com/api/cfc899b2493b4d27943656056e66505a/appointmentData/${editingDataId}`, formData)
                .then((response) => {
                    console.log("Data updated successfully");
                    editingDataId = null; // Reset editingDataId after updating
            ...
            // If editingDataId is null, add new data
            axios.post("https://crudcrud.com/api/cfc899b2493b4d27943656056e66505a/appointmentData", formData)
                .then((response) => {
    ...
    axios.get("https://crudcrud.com/api/cfc899b2493b4d27943656056e66505a/appointmentData")
        .then((response) => {
